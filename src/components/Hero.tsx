      ...
      <div className="relative z-10 max-w-5xl mx-auto px-6 lg:px-8 text-center py-32">
        <div className="space-y-8">
          <h1 className="text-6xl md:text-7xl lg:text-8xl font-light tracking-tight text-balance">
            Роскошь на каждом
            <span className="block font-semibold mt-2">Шагу</span>
          </h1>

          <p className="text-lg md:text-xl text-muted-foreground max-w-2xl mx-auto text-balance leading-relaxed">
            Четыре премиальных отеля — Eleon, Grand Azure Palace, Royal Emerald Residence и Imperial Sapphire Hotel — для вашего идеального отдыха
          </p>
        ...
        <div className="grid grid-cols-3 gap-8 md:gap-16 max-w-3xl mx-auto mt-24 pt-16 border-t border-border/50">
          <div className="space-y-2">
            ...
            <div className="text-sm text-muted-foreground">Премиум-отеля</div>
          </div>
          <div className="space-y-2">
            <div className="text-4xl md:text-5xl font-light">20 000+</div>
